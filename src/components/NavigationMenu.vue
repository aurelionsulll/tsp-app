<template>
	<div>
		<nav
			class="relative flex items-center justify-between px-4 py-2 bg-white"
		>
			<a
			...
			<div class="lg:hidden">
				<button
					class="flex items-center p-3 text-green-400 navbar-burger"
				>
					<svg
			...
			<a
				class="hidden px-6 py-2 text-sm font-bold text-gray-900 transition duration-200 lg:inline-block lg:ml-auto lg:mr-3 bg-gray-50 hover:bg-gray-100 rounded-xl"
				href="#"
				>Sign In</a
			>
			<a
				class="hidden px-6 py-2 text-sm font-bold text-white transition duration-200 bg-green-500 lg:inline-block hover:bg-green-600 rounded-xl"
				href="#"
				>Sign up</a
			>
		</nav>
			...
			>
				...
				<div class="mt-auto">
					<div class="pt-6">
						...
						>
						<a
							class="block px-4 py-3 mb-2 text-xs font-semibold leading-loose text-center text-white bg-green-600 hover:bg-green-700 rounded-xl"
							href="#"
							>Sign Up</a
						>
					</div>
					<p
						class="my-4 text-xs text-center text-gray-400"
					>
						<span
							>Copyright ©
							2021</span
